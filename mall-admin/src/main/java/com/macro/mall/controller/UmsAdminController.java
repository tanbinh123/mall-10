...
public class UmsAdminController {
    ...
    public Object register(@RequestBody UmsAdminParam umsAdminParam, BindingResult result) {
        String icon = umsAdminParam.getIcon();
        if (icon == null) {
            umsAdminParam.setIcon("http://perye-oss.oss-cn-beijing.aliyuncs.com/mall/images/20190410/default.jpg");
        }
    ...
    public Object login(@RequestBody UmsAdminLoginParam umsAdminLoginParam, BindingResult result) {
        ...
        boolean checkStatus = adminService.checkStatus(umsAdminLoginParam.getUsername());
        if (!checkStatus) {
            return new CommonResult().validateFailed("账号已被禁用");
        }
    ...
    public Object list(@RequestParam(value = "name",required = false) String name,
        ...
        List<UmsAdmin> adminList = adminService.list(name,type,pageSize,pageNum);
